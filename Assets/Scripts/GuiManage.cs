...
public class GuiManage : MonoBehaviour {
    ...
    */
	...
	void OnGUI()
	{
		...
		GUI.Box(new Rect(5, 70, 40, 20),"MA");
		//GUI.Box(new Rect(5, 70, 40, 20),"Stam");
		
		
		GUI.Box(new Rect(45,30,barLength,30),playerStat.health.ToString("0")+"/"+maxHealth);
		GUI.Box(new Rect(45,70,barLength,30),playerStat.mana.ToString("0")+"/"+maxMana);
